...
# Detailed Steps for Setting Up the Project on PythonAnywhere
...
3. **Configure the WSGI file**:
   ...
   # Add your project directory to the sys.path
   project_home = '/home/your_username/Hackathon'
   if project_home not in sys.path:
       sys.path.append(project_home)
...
Your Flask application should now be running on PythonAnywhere under the account `Tanishquppal2200`. You can access it via the provided URL.
